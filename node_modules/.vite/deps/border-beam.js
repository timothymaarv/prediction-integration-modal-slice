...
//#region node_modules/.pnpm/border-beam@1.0.1_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/border-beam/dist/index.es.js
...
function he(r, e, a) {
	...
	if (r === "mono") return ue(e, a);
	if (e) return `radial-gradient(ellipse calc(0.8px * var(--beam-spike-${a})) calc(92px * var(--beam-h-${a})) at 8% calc(100% - 2px), ${o}, ${o} 30%, transparent 88%),
       radial-gradient(ellipse calc(10px * var(--beam-spike2-${a})) calc(35px * var(--beam-h-${a})) at 22% calc(100% - 4px), ${p}, ${G(p, .49)} 50%, transparent 95%),
	...
	else return `radial-gradient(ellipse calc(0.8px * var(--beam-spike-${a})) calc(92px * var(--beam-h-${a})) at 8% calc(100% - 2px), ${o}, ${G(o, .85)} 30%, transparent 88%),
       radial-gradient(ellipse calc(10px * var(--beam-spike2-${a})) calc(35px * var(--beam-h-${a})) at 22% calc(100% - 4px), ${p}, ${G(p, .7)} 50%, transparent 95%),
       radial-gradient(ellipse calc(2px * (2 - var(--beam-spike-${a}))) calc(72px * var(--beam-h-${a})) at 36% calc(100% - 3px), ${s[0].color1}, ${s[0].color2} 40%, transparent 90%),
       radial-gradient(ellipse calc(14px * var(--beam-spike2-${a})) calc(28px * var(--beam-h-${a})) at 50% calc(100% - 2px), ${s[1].color1}, ${s[1].color2} 55%, transparent 96%),
       radial-gradient(ellipse calc(1.2px * (2 - var(--beam-spike2-${a}))) calc(85px * var(--beam-h-${a})) at 64% calc(100% - 4px), ${s[2].color1}, ${s[2].color2} 35%, transparent 89%),
       radial-gradient(ellipse calc(7px * var(--beam-spike-${a})) calc(45px * var(--beam-h-${a})) at 78% calc(100% - 2px), ${s[3].color1}, ${s[3].color2} 48%, transparent 94%),
...
function ve(r) {
	const { id: e, borderRadius: a, borderWidth: t, duration: o, strokeOpacity: p, innerOpacity: m, bloomOpacity: s, innerShadow: $, colorVariant: c, staticColors: f, brightness: i, saturation: n, hueRange: l, theme: Y } = r, g = Math.max(0, a - t), b = c === "mono" ? .5 : 1, z = p * b, H = m * b, d = s * b, k = f ? "" : `animation: beam-hue-shift-${e} 12s ease-in-out infinite;`, v = f ? "" : `
...
function we(r) {
	const { id: e, borderRadius: a, borderWidth: t, duration: o, strokeOpacity: p, innerOpacity: m, bloomOpacity: s, innerShadow: $, colorVariant: c, staticColors: f, brightness: i, saturation: n, hueRange: l, theme: Y } = r, g = Math.max(0, a - t), b = Y === "dark", z = p, H = m, d = s, k = f ? "" : `animation: beam-hue-shift-${e} 12s ease-in-out infinite;`, v = f ? "" : `animation: beam-hue-shift-bloom-${e} 8s ease-in-out infinite;`, y = f ? "" : `
@keyframes beam-hue-shift-${e} {
  0% { filter: hue-rotate(-${l}deg) brightness(${i.toFixed(2)}) saturate(${n.toFixed(2)}); }
  50% { filter: hue-rotate(${l}deg) brightness(${i.toFixed(2)}) saturate(${n.toFixed(2)}); }
  100% { filter: hue-rotate(-${l}deg) brightness(${i.toFixed(2)}) saturate(${n.toFixed(2)}); }
...
function We() {
	const [r, e] = (0, import_react.useState)(() => typeof window > "u" || window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light");
...
var Se = (0, import_react.forwardRef)(function({ children: e, size: a = "md", colorVariant: t = "colorful", theme: o = "dark", staticColors: p = !1, duration: m, active: s = !0, borderRadius: $, brightness: c = 1.3, saturation: f, hueRange: i = 30, strength: n = 1, className: l, style: Y, onActivate: g, onDeactivate: b, onAnimationEnd: z, ...H }, d) {
	const v = (0, import_react.useId)().replace(/:/g, "-"), y = We(), W = (0, import_react.useRef)(null), [h, X] = (0, import_react.useState)(s), [x, F] = (0, import_react.useState)(!1), [D, J] = (0, import_react.useState)(null);
	...
	const U = (0, import_react.useCallback)((u) => {
		const S = u.animationName;
		S.includes("fade-out") ? (X(!1), F(!1), b?.()) : S.includes("fade-in") && g?.(), z?.(u);
	}, [
		g,
		b,
		z
	]), C = Xe(o, y), w = I[a][C], M = ce[a], j = $ ?? D ?? M.borderRadius, T = m ?? (a === "line" ? 2.4 : 1.96), P = f ?? w.saturation, N = a === "line" ? Math.min(i, 13) : i, _ = t === "mono" ? !0 : p, Z = (0, import_react.useMemo)(() => ke({
		id: v,
		borderRadius: j,
		...
		N,
		C
	]), ee = (0, import_react.useCallback)((u) => {
		W.current = u, typeof d == "function" ? d(u) : d && (d.current = u);
	}, [d]), ae = {
		...Y ?? {},
		"--beam-strength": Math.max(0, Math.min(1, n))
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: Z }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...H,
		ref: ee,
		"data-beam": v,
		...
		style: ae,
		onAnimationEnd: U,
		children: [e, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "data-beam-bloom": !0 })]
	})] });
});
//#endregion
export { Se as BorderBeam, Se as default, ce as sizePresets, I as sizeThemePresets, Fe as themeColors };
